...
`main` @ `cf518b1` -- includes through PR #18. In order:
...
- Deploy PR #16-#18 (collapsible add-contracts/add-trim; Target field move + trade screenshots; dated-contract multiplier fix) to dev, then production, once confirmed.
